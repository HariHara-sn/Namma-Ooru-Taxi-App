...
describe('FareCalculatorService', () => {
  ...
  describe('calculateFare', () => {
    ...
    test('should respect min fare limit for different vehicle types', () => {
      ...
      expect(sedanResult.fare).toBeGreaterThanOrEqual(mockConfig.vehicleTypes.SEDAN.minFare);
      expect(bikeResult.fare).toBeGreaterThanOrEqual(mockConfig.vehicleTypes.BIKE.minFare);
    });
    ...
    test('should respect max fare limit for different vehicle types', () => {
      ...
      expect(sedanResult.fare).toBeLessThanOrEqual(mockConfig.vehicleTypes.SEDAN.maxFare);
      expect(suvResult.fare).toBeLessThanOrEqual(mockConfig.vehicleTypes.SUV.maxFare);
    });
    ...
    test('should include subtotal in breakdown (base + distance + time + zone + surge)', () => {
      ...
      const baseComponents = result.breakdown.baseFare + 
      ...
      const expectedSubtotal = baseComponents * result.breakdown.surgeAdjustment.multiplier;
  ...
  describe('getAvailableVehicleTypes', () => {
    test('should return available vehicle types', () => {
      const vehicleTypes = FareCalculatorService.getAvailableVehicleTypes(mockConfig);
...
describe('IncentiveService', () => {
  ...
  test('should calculate acceptance rate correctly', () => {
    const performance = IncentiveService.getDriverPerformanceSummary(mockDriverMeta);
